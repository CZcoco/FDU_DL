...
|------|-------------|
| SGD（无调度） | **96.67%** | 
| SGD + MultiStepLR | 94.98% | 
| MomentGD + MultiStepLR | 95.94% |
...
| 实验 | 模型 | 验证集 Acc | 参数量 | 
|------|------|-----------|--------|
| Part A baseline | MLP | 95.1% | ~476K |
| Part B | CNN (3 epochs) | 96.2% | ~42K |
| Part C - SGD only | MLP | 96.67% | ~476K | 
| Part C - SGD+MultiStepLR | MLP | 94.98% | ~476K |
| Part C - MomentGD+MultiStepLR | MLP | 95.94% | ~476K |
